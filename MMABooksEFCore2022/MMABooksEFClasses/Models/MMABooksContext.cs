...
namespace MMABooksEFClasses.Models
{
    ...
    //MMABooksContext derives from DbContext. It is the thing that knows how to work with the other classes
    //in the model folder that got created by entity framework
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            if (!optionsBuilder.IsConfigured)
            {
                ...
                #warning you should move it out of source code. You can avoid scaffolding the connection string by using the 
                #warning Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. 
                #warning For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.

                // optionsBuilder.UseMySql("server=127.0.0.1;uid=root;pwd=LaneCC;database=MMABooks",
    ...
    } // end class MMABooksContext : DbContext
